...
if __name__ == '__main__':
    ...
    for repeat in range(1):
        ...
        if args.eval_neg_samples > 1:
            ...
            print('\ttest AP: {:.4f}  test AUC: {:.4f}  Average time: {:.2f}\n'.format(ap, auc, total_time/(e+1)))
            
    print('average ap: {:.4f} ,average auc: {:.4f} ,average time: {:.2f}'.format(np.mean(repeat_ap), np.mean(repeat_auc), np.mean(repeat_time)))